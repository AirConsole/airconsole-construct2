...
AddNumberParam('Device id', 'Device id to get custom device state from');
AddAction(20, af_none, 'Get language', 'Profile', 'Returns the current IETF language tag of device id = {0}', 'Returns the current IETF language tag of a device e.g. "en" or "en-US"', 'GetLanguage');
...
function IDEInstance(instance, type) {
    ...
    for (leti = 0; i < property_list.length; i++)
