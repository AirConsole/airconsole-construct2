...
AddAction(12, af_none, 'Get custom device state', 'Messaging', 'Gets the custom DeviceState of a device.', 'Gets the custom DeviceState of a device.', 'GetCustomDeviceState')
